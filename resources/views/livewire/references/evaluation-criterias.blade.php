                ...
                <div class="row mb-4">
                    <div class="col">
                        <div class="btn-group d-flex" role="group">
                            <button type="button" 
                                class="btn fw-semibold py-2 px-4 
                                {{ $assessmentCriteria ? 'btn-primary' : 'btn-outline-primary' }}" 
                                wire:click="setCriteria('assessment')">
                                <i class="bi bi-clipboard-check me-1"></i> Assessment Test
                            </button>
                
                            <button type="button" 
                                class="btn fw-semibold py-2 px-4 
                                {{ $practicalCriteria ? 'btn-secondary' : 'btn-outline-secondary' }}" 
                                wire:click="setCriteria('practical')">
                                <i class="bi bi-tools me-1"></i> Practical Test
                            </button>
                
                            <button type="button" 
                                class="btn fw-semibold py-2 px-4 
                                {{ $oralCriteria ? 'btn-dark' : 'btn-outline-dark' }}" 
                                wire:click="setCriteria('oral')">
                                <i class="bi bi-chat-left-text me-1"></i> Oral Interview
                            </button>
                        </div>
                    </div>
                </div>
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group" aria-label="Criteria actions">
                                        ...
                                        <button class="btn btn-sm {{$item->deleted_at == Null ? 'btn-danger' : 'btn-outline-success'}} rounded-2 px-2 py-1"
                                            wire:click='{{$item->deleted_at == Null ? 'confirmDelete('.$item->id.')': 'restoreCriteria('.$item->id.')'}}'
                                            data-bs-toggle="tooltip"
