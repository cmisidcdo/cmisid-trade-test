            ...
            <div class="card-body p-4">
                ...
                <div class="d-flex gap-2">
                    ...
                    <button type="button" class="btn btn-primary btn-sm d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#createScheduleModal">
                        <i class="bi bi-plus-lg me-1"></i> Create Schedule for Practical
                    </button>
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content" style="border-radius: 12px;">
                                <div class="modal-body p-4">
                                    <h5 class="text-center mb-4 fw-bold" style="color: black;">Create Schedule for Practical Exam</h5>
                                    <form>
                                        <div class="row g-3">
                                            <!-- Select Candidate -->
                                            <div class="col-md-6">
                                        ...
                                        <div class="col-12">
                                            <div class="d-flex justify-content-between align-items-center mb-2 mt-3">
                                                <h5 class="fw-semibold mb-0">Practical Exam Questions</h5>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table text-center mt-2">
                                                    <thead style="border-collapse: collapse;">
                                                        <tr>
                                                            <th style="background-color: #1A1851; color: white; border: 1px solid #1A1851;">Scenarios</th>
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content" style="border-radius: 12px;">
                                <div class="modal-body p-4">
                                    <h5 class="text-center mb-4 fw-bold" style="color: black;">Schedule for Practical Exam</h5>
                                    <form>
                                        <div class="row g-3">
                                            <!-- Select Candidate -->
                                            <div class="col-md-6">
                    ...
                    <table class="table text-center mt-2">
                        ...
                        <tbody style="border: 1px solid #ccc; border-collapse: collapse;">
                            <tr>
                                ...
                                <td style="border: 1px solid black;">03/28/2025</td>
