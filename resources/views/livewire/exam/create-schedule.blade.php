                ...
                <div class="d-flex gap-2">
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content" style="border-radius: 12px;">
                                <div class="modal-body p-4">
                                    <h5 class="text-center mb-4 fw-bold" style="color: black;">Create Schedule for Assessment Test</h5>
                                    <form>
                                        <div class="row g-3">
                                            <!-- Select Candidate -->
                                            <div class="col-md-6">
                                        ...
                                        <div class="col-12">
                                            <div class="d-flex justify-content-between align-items-center mb-2 mt-3">
                                                <h5 class="fw-semibold mb-0">Assessment Exam Questions</h5>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table text-center mt-2">
                                                    <thead style="border-collapse: collapse;">
                                                        <tr>
                                                            <th style="background-color: #1A1851; color: white; border: 1px solid #1A1851;">Assessment Exam Questions</th>
                    ...
                    <div class="modal fade" id="viewModal" tabindex="-1" aria-labelledby="viewModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content" style="border-radius: 12px;">
                                <div class="modal-body p-4">
                                    <h5 class="text-center mb-4 fw-bold" style="color: black;">Schedule for Assessment Test</h5>
                                    <form>
                                        <div class="row g-3">
                                            <!-- Select Candidate -->
                                            <div class="col-md-6">
