<div>
    <div class="card-header text-white text-center py-3" style="background-color: #1a1851; border-radius: 12px 12px 0 0;">
        <h2 class="fw-bold m-0">Oral Questions</h2>
    </div>
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div class="d-flex gap-2">
                    <button class="btn btn-primary" wire:click="showAddEditModal">
                        <i class="bi bi-plus"></i> Oral Question
                    </button>
                        ...
                        <td style="width: 15%;">
                            <div class="d-flex align-items-center justify-content-center gap-2">
                                <button class="btn btn-sm btn-info rounded-2"
                                    wire:click='viewOralQuestion({{$item->position_id}})'
                                ...
                                <button class="btn btn-sm btn-primary rounded-2"
                                    wire:click='readOralQuestion({{$item->position_id}})'
                                    data-bs-toggle="tooltip"
                                    data-bs-title="Edit Questions">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content shadow">
                <div class="modal-header bg-primary text-white py-2">
                    <h5 class="modal-title fw-bold text-center w-100 fs-6" id="oralQuestionModalLabel">
                        {{ $editMode ? 'Update Oral Questions' : ($viewMode ? 'View Oral Questions' : 'Add Oral Questions') }}
                    </h5>
