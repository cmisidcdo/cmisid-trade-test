<div>
    <div class="card-header text-white text-center py-3" style="background-color: #1a1851; border-radius: 12px 12px 0 0;">
        <h2 class="fw-bold m-0">Update Practical Scenarios</h2>
    </div>
                    ...
                    <div class="scenario-set mb-4 p-3 border rounded-3" style="border: 2px solid #ddd;">
                        ...
                        <div class="mb-2">
                            ...
                            <textarea class="form-control form-control-sm fs-7 @error('scenarios.' . $index . '.scenario') is-invalid @enderror"
                                id="scenario_{{ $index }}" rows="2" wire:model.live.debounce.500ms="scenarios.{{ $index }}.scenario" placeholder="Enter your scenario here" maxlength="255"></textarea>
