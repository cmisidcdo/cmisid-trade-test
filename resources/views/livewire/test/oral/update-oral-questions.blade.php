                    ...
                    <div class="question-set mb-4 p-3 border rounded-3" style="border: 2px solid #ddd;">
                        ...
                        <div class="mb-2">
                            ...
                            <textarea class="form-control form-control-sm fs-7 @error('questions.' . $index . '.question') is-invalid @enderror"
                                id="question_{{ $index }}" rows="2" wire:model.live.debounce.500ms="questions.{{ $index }}.question" placeholder="Enter your question here" maxlength="255" {{ $archive ? 'readonly' : '' }}></textarea>
                        ...
                        <div class="mb-2">
                            ...
                            <textarea class="form-control form-control-sm fs-7 @error('questions.' . $index . '.description') is-invalid @enderror"
                                id="description_{{ $index }}" rows="2" wire:model.live.debounce.500ms="questions.{{ $index }}.description"  maxlength="255" placeholder="Enter your description here" {{ $archive ? 'readonly' : '' }}></textarea>
                            <div class="text-end small text-muted">
                        ...
                        <div class="row mb-2">
                                ...
                                <div class="col mb-2">
                                    ...
                                    @if (!$archive && (empty($question['existing_file']) || (!empty($replaceFileVisibility[$index]) && $replaceFileVisibility[$index])))
                                        <input type="file"
                                            ...
                                            accept=".pdf,.png,.jpg,.jpeg" {{ $archive ? 'disabled' : '' }}>
                            ...
                            <div class="col-6">
                                ...
                                <div class="d-flex">
                                    <input type="number" class="form-control form-control-sm fs-7" min="0" max="23" placeholder="HH" wire:model="questions.{{ $index }}.hours" style="max-width: 70px;" maxlength="2" oninput="this.value = this.value.slice(0, 2);" {{ $archive ? 'readonly' : '' }}>
                                    <span class="mx-1">:</span>
                                    <input type="number" class="form-control form-control-sm fs-7" min="0" max="59" placeholder="MM" wire:model="questions.{{ $index }}.minutes" style="max-width: 70px;" maxlength="2" oninput="this.value = this.value.slice(0, 2);" {{ $archive ? 'readonly' : '' }}>
                                    <span class="mx-1">:</span>
                                    <input type="number" class="form-control form-control-sm fs-7" min="0" max="59" placeholder="SS" wire:model="questions.{{ $index }}.seconds" style="max-width: 70px;" maxlength="2" oninput="this.value = this.value.slice(0, 2);" {{ $archive ? 'readonly' : '' }}>
                                </div>
                            </div>
                        </div>
                    </div>
